setTimeout(() => {
    const fontFace = new FontFace('Varela Round', 'url(https://github.com/wicorn29/uWicLet/raw/refs/heads/main/wicorn29font.woff)');
    ...
    document.addEventListener("keydown", function (blob) {
        if (blob.code == "Backquote" && blob.ctrlKey && blob.shiftKey && !blobFrame && !isClosing) {
            ...
            fetch("https://raw.githubusercontent.com/wicorn29/uWicLet/refs/heads/main/main.html")
                ...
                .then(html => {
                    const uWicLetHtml = blobFrame.contentDocument || blobFrame.contentWindow.document;
                    uWicLetHtml.open();
                    uWicLetHtml.write(html);
                    uWicLetHtml.close();
                });
            ...
            titleText.innerText = "uWicLet"; // Updated name
