(function() {
    ...
    function openIframe() {
        ...
        // Append the title and close button to the bar
        bar.appendChild(titleText);
        bar.appendChild(closeButton);
        
        // Add drag functionality to the bar
        bar.addEventListener("mousedown", startDragging);
        
        // Append iframe and bar to container
    ...
    function closeIframe() {
        if (isOpening || isClosing) return;
        isClosing = true;
        blobFrameContainer.style.transition = "opacity 0.2s ease";
    ...
    // Run the iframe opening function directly
    openIframe();
})();
